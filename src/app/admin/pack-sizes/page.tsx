        ...
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-muted-foreground">Manage predefined pack quantities for products.</p>
                </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>A list of all available packaging quantities.</CardDescription>
                </CardHeader>
                <CardContent>
                    <Table>
                        <TableHeader>
            ...
            <Dialog open={dialogState.open} onOpenChange={handleOpenChange}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>Enter the quantity for the pack size.</DialogDescription>
                    </DialogHeader>
                    <div className="space-y-4 py-4">
                        <div className="space-y-2">
                            <Label htmlFor="quantity">Quantity</Label>
                            <Input id="quantity" type="number" value={quantity} onChange={(e) => setQuantity(Number(e.target.value))} placeholder="e.g., 100" />
                        </div>
                    </div>
                    <DialogFooter>
